...
#include(pergamino2020/inicializacionModeloDaniela_PriceLandAdjustmentV6_5x5.inc)
...
rule: { 
		...
		~price_backup4  := if ((0,0)~price_backup4 = 1, 9, 8); % no se actualiza cuando ya se backupeo
...
rule: { 
	...
	~lu1 := if ( $percLu1PriceChange > 0.1 and $percLu2PriceChange <=0.1  and $percLu4PriceChange <= 0.1, (0,0)~lu1 + (0,0)~lu2 * 0.125 +(0,0)~lu3 * 0.125,	
...
rule: { 
	...
	~lu1 := if( $percLu1PriceChange > 0.1 and $percLu2PriceChange < -0.1 and abs($percLu4PriceChange) < 0.1 , (0,0)~lu1 + (0,0)~lu2 * 0.25 ,
		...
		if( abs($percLu1PriceChange) < 0.1 and $percLu2PriceChange > 0.1 and $percLu4PriceChange > 0.1, (0,0)~lu1 * 0.75,			
		if( abs($percLu1PriceChange) < 0.1 and $percLu2PriceChange < -0.1 and $percLu4PriceChange > 0.1, (0,0)~lu1 ,	
	...
	~lu2 := if( $percLu2PriceChange > 0.1 and $percLu1PriceChange < -0.1 and abs($percLu4PriceChange) < 0.1 , (0,0)~lu2 + (0,0)~lu1 * 0.25 ,
		if( $percLu2PriceChange > 0.1 and $percLu1PriceChange < -0.1 and $percLu4PriceChange < -0.1, (0,0)~lu2 + (0,0)~lu1 * 0.125  + (0,0)~lu3 * 0.125,
		if( $percLu2PriceChange > 0.1 and $percLu1PriceChange < -0.1 and $percLu4PriceChange > 0.1, (0,0)~lu2 + (0,0)~lu1 * 0.125,				
		if( $percLu2PriceChange > 0.1 and abs($percLu1PriceChange) < 0.1 and abs($percLu4PriceChange) < 0.1, (0,0)~lu2 + (0,0)~lu1 * 0.125  + (0,0)~lu3 * 0.125,	
		if( $percLu2PriceChange > 0.1 and abs($percLu1PriceChange) < 0.1 and $percLu4PriceChange < -0.1, (0,0)~lu2 + (0,0)~lu3 * 0.25 ,
		if( $percLu2PriceChange > 0.1 and abs($percLu1PriceChange) < 0.1 and $percLu4PriceChange > 0.1, (0,0)~lu2 + (0,0)~lu1 * 0.125,			
		if( $percLu2PriceChange > 0.1 and $percLu1PriceChange > 0.1 and $percLu4PriceChange < -0.1, (0,0)~lu2 + (0,0)~lu3 * 0.125,	
		if( $percLu2PriceChange > 0.1 and $percLu1PriceChange > 0.1 and abs($percLu4PriceChange) < 0.1, (0,0)~lu2 + (0,0)~lu3 * 0.125,			
		if( $percLu2PriceChange > 0.1 and $percLu1PriceChange > 0.1 and $percLu4PriceChange > 0.1, (0,0)~lu2 ,				
		if( abs($percLu2PriceChange) < 0.1 and abs($percLu1PriceChange) < 0.1 and abs($percLu4PriceChange) < 0.1, (0,0)~lu2 ,
		if( abs($percLu2PriceChange) < 0.1 and abs($percLu1PriceChange) < 0.1 and $percLu4PriceChange > 0.1, (0,0)~lu2 * 0.875,			
		if( abs($percLu2PriceChange) < 0.1 and abs($percLu1PriceChange) < 0.1 and $percLu4PriceChange < -0.1, (0,0)~lu2 + (0,0)~lu3 * 0.125,			
		if( abs($percLu2PriceChange) < 0.1 and $percLu1PriceChange > 0.1 and abs($percLu4PriceChange) < 0.1, (0,0)~lu2 * 0.875,		
		if( abs($percLu2PriceChange) < 0.1 and $percLu1PriceChange > 0.1 and $percLu4PriceChange < -0.1, (0,0)~lu2 ,		
		if( abs($percLu2PriceChange) < 0.1 and $percLu1PriceChange > 0.1 and $percLu4PriceChange > 0.1, (0,0)~lu2 * 0.75,			
		if( abs($percLu2PriceChange) < 0.1 and $percLu1PriceChange < -0.1 and $percLu4PriceChange > 0.1, (0,0)~lu2 ,	
		if( abs($percLu2PriceChange) < 0.1 and $percLu1PriceChange < -0.1 and $percLu4PriceChange < -0.1, (0,0)~lu2 + (0,0)~lu1 * 0.125 +(0,0)~lu3 * 0.125,	
		if( abs($percLu2PriceChange) < 0.1 and $percLu1PriceChange < -0.1 and abs($percLu4PriceChange) < 0.1, (0,0)~lu2 + (0,0)~lu1 * 0.125,	
		if( $percLu2PriceChange < -0.1 and abs($percLu1PriceChange) < 0.1 and $percLu4PriceChange > 0.1, (0,0)~lu2 * 0.75,	
		if( $percLu2PriceChange < -0.1 and abs($percLu1PriceChange) < 0.1 and $percLu4PriceChange < -0.1, (0,0)~lu2 * 0.875,				
		if( $percLu2PriceChange < -0.1 and abs($percLu1PriceChange) < 0.1 and abs($percLu4PriceChange) < 0.1, (0,0)~lu2 * 0.75,			
		if( $percLu2PriceChange < -0.1 and $percLu1PriceChange > 0.1 and abs($percLu4PriceChange) < 0.1, (0,0)~lu2 * 0.75,	
		if( $percLu2PriceChange < -0.1 and $percLu1PriceChange > 0.1 and $percLu4PriceChange < -0.1, (0,0)~lu2 * 0.875,		
		if( $percLu2PriceChange < -0.1 and $percLu1PriceChange > 0.1 and $percLu4PriceChange > 0.1, (0,0)~lu2 * 0.75,		
		if( $percLu2PriceChange < -0.1 and $percLu1PriceChange < -0.1 and $percLu4PriceChange < -0.1, (0,0)~lu2,				
		if( $percLu2PriceChange < -0.1 and $percLu1PriceChange < -0.1 and abs($percLu4PriceChange) < 0.1, (0,0)~lu2 * 0.875,	
		if( $percLu2PriceChange < -0.1 and $percLu1PriceChange < -0.1 and $percLu4PriceChange > 0.1, (0,0)~lu2 * 0.875,			
		(0,0)~lu2 	)))))))))))))))))))))))))));	

	~lu3 := if( $percLu4PriceChange > 0.1 and $percLu1PriceChange < -0.1 and abs($percLu2PriceChange) < 0.1 , (0,0)~lu3 + (0,0)~lu1 * 0.25 ,
		if( $percLu4PriceChange > 0.1 and $percLu1PriceChange < -0.1 and $percLu2PriceChange < -0.1, (0,0)~lu3 + (0,0)~lu1 * 0.125  + (0,0)~lu2 * 0.125,
		if( $percLu4PriceChange > 0.1 and $percLu1PriceChange < -0.1 and $percLu2PriceChange > 0.1, (0,0)~lu3 + (0,0)~lu1 * 0.125,				
		if( $percLu4PriceChange > 0.1 and abs($percLu1PriceChange) < 0.1 and abs($percLu2PriceChange) < 0.1, (0,0)~lu3 + (0,0)~lu1 * 0.125  + (0,0)~lu2 * 0.125,	
		if( $percLu4PriceChange > 0.1 and abs($percLu1PriceChange) < 0.1 and $percLu2PriceChange < -0.1, (0,0)~lu3 + (0,0)~lu2 * 0.25 ,
		if( $percLu4PriceChange > 0.1 and abs($percLu1PriceChange) < 0.1 and $percLu2PriceChange > 0.1, (0,0)~lu3 + (0,0)~lu1 * 0.125,			
		if( $percLu4PriceChange > 0.1 and $percLu1PriceChange > 0.1 and $percLu2PriceChange < -0.1, (0,0)~lu3 + (0,0)~lu2 * 0.125,	
		if( $percLu4PriceChange > 0.1 and $percLu1PriceChange > 0.1 and abs($percLu2PriceChange) < 0.1, (0,0)~lu3 + (0,0)~lu2 * 0.125,			
		if( $percLu4PriceChange > 0.1 and $percLu1PriceChange > 0.1 and $percLu2PriceChange > 0.1, (0,0)~lu3 ,					
		if( abs($percLu4PriceChange) < 0.1 and abs($percLu1PriceChange) < 0.1 and abs($percLu2PriceChange) < 0.1, (0,0)~lu3 ,
		if( abs($percLu4PriceChange) < 0.1 and abs($percLu1PriceChange) < 0.1 and $percLu2PriceChange > 0.1, (0,0)~lu3 * 0.875,			
		if( abs($percLu4PriceChange) < 0.1 and abs($percLu1PriceChange) < 0.1 and $percLu2PriceChange < -0.1, (0,0)~lu3 + (0,0)~lu2 * 0.125,			
		if( abs($percLu4PriceChange) < 0.1 and $percLu1PriceChange > 0.1 and abs($percLu2PriceChange) < 0.1, (0,0)~lu3 * 0.875,		
		if( abs($percLu4PriceChange) < 0.1 and $percLu1PriceChange > 0.1 and $percLu2PriceChange < -0.1, (0,0)~lu3 ,		
		if( abs($percLu4PriceChange) < 0.1 and $percLu1PriceChange > 0.1 and $percLu2PriceChange > 0.1, (0,0)~lu3 * 0.75,			
		if( abs($percLu4PriceChange) < 0.1 and $percLu1PriceChange < -0.1 and $percLu2PriceChange > 0.1, (0,0)~lu3 ,	
		if( abs($percLu4PriceChange) < 0.1 and $percLu1PriceChange < -0.1 and $percLu2PriceChange < -0.1, (0,0)~lu3 + (0,0)~lu1 * 0.125 +(0,0)~lu2 * 0.125,	
		if( abs($percLu4PriceChange) < 0.1 and $percLu1PriceChange < -0.1 and abs($percLu2PriceChange) < 0.1, (0,0)~lu3 + (0,0)~lu1 * 0.125,	
		if( $percLu4PriceChange < -0.1 and abs($percLu1PriceChange) < 0.1 and $percLu2PriceChange > 0.1, (0,0)~lu3 * 0.75,	
		if( $percLu4PriceChange < -0.1 and abs($percLu1PriceChange) < 0.1 and $percLu2PriceChange < -0.1, (0,0)~lu3 * 0.875,				
		if( $percLu4PriceChange < -0.1 and abs($percLu1PriceChange) < 0.1 and abs($percLu2PriceChange) < 0.1, (0,0)~lu3 * 0.75,			
		if( $percLu4PriceChange < -0.1 and $percLu1PriceChange > 0.1 and abs($percLu2PriceChange) < 0.1, (0,0)~lu3 * 0.75,	
		if( $percLu4PriceChange < -0.1 and $percLu1PriceChange > 0.1 and $percLu2PriceChange < -0.1, (0,0)~lu3 * 0.875,		
		if( $percLu4PriceChange < -0.1 and $percLu1PriceChange > 0.1 and $percLu2PriceChange > 0.1, (0,0)~lu3 * 0.75,		
		if( $percLu4PriceChange < -0.1 and $percLu1PriceChange < -0.1 and $percLu2PriceChange < -0.1, (0,0)~lu3,				
		if( $percLu4PriceChange < -0.1 and $percLu1PriceChange < -0.1 and abs($percLu2PriceChange) < 0.1, (0,0)~lu3 * 0.875,	
		if( $percLu4PriceChange < -0.1 and $percLu1PriceChange < -0.1 and $percLu2PriceChange > 0.1, (0,0)~lu3 * 0.875,			
		(0,0)~lu3 	)))))))))))))))))))))))))));		
