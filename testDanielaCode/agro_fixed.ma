...
#include(153/inicializacion.inc)
...
neighborports: amb mgm lu1 lu2 lu3 pro eme ua_tipo ua_cota ue_cota deg uae uao uee ueo alq etapa cam_copia
...
rule: { 
	...
	{ 
		...
		%and
		%(not isUndefined((0,0)~lu1!0)) 	and
		%(not isUndefined((0,0)~lu2!0)) 	and
		%(not isUndefined((0,0)~lu3!0)) 	and
		%(not isUndefined((0,0)~mgm!0))
	}
...
rule: { 
	...
	{ 
		...
		(not isUndefined((-1,0)~pro!0))	 		and
		(
			(-1,0)~pro > ((0,0)~ue_cota + ((0,0)~ue_cota * #macro(ajuste_ambiente))) and
			(isUndefined((-1,1)~pro!0) or  (-1,1)~pro		<= (-1,0)~pro)	and
			(isUndefined((0,1)~pro!0) or  (0,1)~pro 		<= (-1,0)~pro)	and
			(isUndefined((1,1)~pro!0) or  (1,1)~pro 		<= (-1,0)~pro)	and
			(isUndefined((1,0)~pro!0) or  (1,0)~pro 		<= (-1,0)~pro)	and
			(isUndefined((1,-1)~pro!0) or  (1,-1)~pro 	<= (-1,0)~pro)	and
			(isUndefined((0,-1)~pro!0) or  (0,-1)~pro 	<= (-1,0)~pro)	and
			(isUndefined((-1,-1)~pro!0) or  (-1,-1)~pro 	<= (-1,0)~pro)		
		)
	}
...
rule: { 
	...
	{ 
		(0,0)#macro(parametrosCalculados) 		and
		#macro(vecinosParametrosCalculados) 	and
		(not isUndefined((-1,1)~pro!0)) 			and
		(
			(-1,1)~pro > ((0,0)~ue_cota + ((0,0)~ue_cota * #macro(ajuste_ambiente))) and
			(isUndefined((0,1)~pro!0) or  (0,1)~pro 		<= (-1,1)~pro)	and
			(isUndefined((1,1)~pro!0) or  (1,1)~pro 		<= (-1,1)~pro)	and
			(isUndefined((1,0)~pro!0) or  (1,0)~pro 		<= (-1,1)~pro)	and
			(isUndefined((1,-1)~pro!0) or  (1,-1)~pro 	<= (-1,1)~pro)	and
			(isUndefined((0,-1)~pro!0) or  (0,-1)~pro 	<= (-1,1)~pro)	and
			(isUndefined((-1,-1)~pro!0) or  (-1,-1)~pro 	<= (-1,1)~pro)	and	
			(isUndefined((-1,0)~pro!0) or  (-1,0)~pro 	<= (-1,1)~pro)
		)									
	}
...
rule: { 
	...
	{ 
		(0,0)#macro(parametrosCalculados)	 	and
		#macro(vecinosParametrosCalculados) 	and
		(not isUndefined((0,1)~pro!0)) 			and
		(
			(0,1)~pro > ((0,0)~ue_cota + ((0,0)~ue_cota * #macro(ajuste_ambiente))) and
			(isUndefined((1,1)~pro!0) or  (1,1)~pro 		<= (0,1)~pro)	and
			(isUndefined((1,0)~pro!0) or  (1,0)~pro 		<= (0,1)~pro)	and
			(isUndefined((1,-1)~pro!0) or  (1,-1)~pro		<= (0,1)~pro)	and
			(isUndefined((0,-1)~pro!0) or  (0,-1)~pro		<= (0,1)~pro)	and
			(isUndefined((-1,-1)~pro!0) or  (-1,-1)~pro 	<= (0,1)~pro)	and	
			(isUndefined((-1,0)~pro!0) or  (-1,0)~pro		<= (0,1)~pro)	and
			(isUndefined((-1,1)~pro!0) or  (-1,1)~pro		<= (0,1)~pro)
		)
	}
...
rule: { 
	...
	{ 
		...
		(
			...
			(isUndefined((-1,0)~pro!0) or  (-1,0)~pro 	<= (1,1)~pro)	and
			(isUndefined((-1,1)~pro!0) or  (-1,1)~pro 	<= (1,1)~pro)	and
			(isUndefined((0,1)~pro!0) or  (0,1)~pro 		<= (1,1)~pro)	
		)
	}
