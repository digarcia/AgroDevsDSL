...
public class AgroDevsDSLParser extends Parser {
	...
	public static class RContext extends ParserRuleContext {
		...
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof AgroDevsDSLListener ) ((AgroDevsDSLListener)listener).enterR(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof AgroDevsDSLListener ) ((AgroDevsDSLListener)listener).exitR(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof AgroDevsDSLVisitor ) return ((AgroDevsDSLVisitor<? extends T>)visitor).visitR(this);
